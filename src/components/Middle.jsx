...
const Middle = () => {
    return (
        <div>
            ...
            <div className='flex max-[320px]:flex-col max-[375px]:flex-col  max-[375px]:h-auto  max-[320px]:h-auto  max-[320px]:space-y-5 max-[375px]:space-y-5  text-black space-x-10 justify-center max-[375px]:items-center max-[425px]:items-center mt-10'>
                <div className='bg-[#FDF0CD] flex rounded-md  items-center space-x-5 pr-5 max-[320px]:pr-1 max-[320px]:w-60 max-[375px]:w-96 max-[320px]:ml-10 max-[375px]:ml-10 pt-2 pb-2 hover:-translate-y-3 hover:transition hover:duration-300'>
                    <img className='w-5 max-[375px]:w-10 h-5 max-[375px]:h-10 -mt-10 max-[425px]:w-5' src={clipboard} alt="" />
                    <div>
                ...
                <div className='bg-[#FDF0CD] flex rounded-md  items-center space-x-5 pr-5 max-[320px]:pr-1 max-[320px]:w-60 max-[375px]:w-96 max-[320px]:pt-8 max-[375px]:pt-8 max-[320px]:pb-5 max-[375px]:pb-5 pt-2 pb-2 hover:-translate-y-3 hover:transition hover:duration-300'>
                    ...
                    <div className='-mt-5 max-[425px]:-mt-5'>
                        ...
                        <p className='font-Sora text-[12px] max-[375px]:text-[20px] max-[425px]:text-[16px]'>Lorem ipsum lorem</p>
                    </div>
                ...
                <div className='bg-[#FDF0CD] flex rounded-md  items-center max-[425px]:justify-center space-x-5 pr-5 max-[320px]:pr-1 max-[320px]:w-60 max-[375px]:w-96 max-[320px]:pt-8 max-[375px]:pt-8 max-[320px]:pb-5 max-[375px]:pb-5 pt-2 pb-2 hover:-translate-y-3 hover:transition hover:duration-300'>
